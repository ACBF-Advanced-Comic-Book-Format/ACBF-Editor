...
class LanguageDialog(Gtk.Window):
    ...
    def setup_lang_column(self, factory: Gtk.ListItemFactory, list_item: Gtk.ListItem) -> None:
        entry = Gtk.Label()
        entry.set_halign(Gtk.Align.START)
        entry.set_margin_start(3)
        list_item.set_child(entry)

    def setup_lang_iso_column(self, factory: Gtk.ListItemFactory, list_item: Gtk.ListItem) -> None:
        entry = Gtk.DropDown()
    ...
    def bind_lang_iso_column(self, factory: Gtk.ListItemFactory, list_item: Gtk.ListItem) -> None:
        item: Language = list_item.get_item()
    ...
    def unbind_lang_iso_column(self, factory: Gtk.ListItemFactory, list_item: Gtk.ListItem) -> None:
        entry: Gtk.DropDown = list_item.get_child()
    ...
    def active_toggle(self, widget: Gtk.CheckButton, item: Language) -> None:
    ...
    def add_lang(self, button: Gtk.Button) -> None:
        self.model.append(Language())
        self.set_modified()

    def lang_iso_change(self, widget: Gtk.DropDown, _pspec: GObject.GParamSpec, item: Language) -> None:
    ...
    def compare_lang(self, item: GObject, model: Gio.ListStore) -> int:
    ...
    def save_and_exit(self, widget: Gtk.Button) -> None:
        if self.is_modified:
            ...
            while i < 9999:
                ...
                self.parent.acbf_document.languages.append(
                    (lang.lang_iso, lang.show),
                )
                i = i + 1
